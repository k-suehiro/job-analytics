...
function doGet(e) {
  ...
  if (page === 'help') {
    var helpTemplate = HtmlService.createTemplateFromFile('help');
    helpTemplate.serviceUrl = getGasServiceUrl();
  ...
  template.gasInitBase64 = Utilities.base64Encode(
    JSON.stringify(buildGasClientInit(accessKey)),
